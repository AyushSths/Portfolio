    ...
    <div className='main-home max-w-[1480px] m-auto md:pt-75 pt-15 2xl:px-3 px-6'>
      <div className="home md:gap-x-[40px] gap-y-[10px]">
        <section className="l-section flex flex-col md:gap-y-6 gap-y-3 w-full">
            ...
            <div className="des">
                <p className='lg:text-lg md:text-base text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis alias eveniet maxime, maiores impedit ad quas tenetur eos rerum magni consectetur obcaecati sint reiciendis aperiam vero ipsam temporibus, sit amet?</p>
            </div>
